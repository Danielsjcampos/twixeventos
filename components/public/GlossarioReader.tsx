  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      {estado === 'parado' && (
        <button
          onClick={iniciar}
          className="inline-flex items-center gap-2 bg-brand-accent hover:bg-brand-accent/90 text-white font-bold text-sm px-4 py-2 rounded-xl transition-colors"
        >
      ...
      {estado === 'lendo' && (
        <>
          <button
            onClick={pausar}
            className="inline-flex items-center gap-2 bg-brand-surface-2 border border-brand-border hover:border-brand-accent text-brand-text font-bold text-sm px-4 py-2 rounded-xl transition-colors"
          >
            <Pause className="size-4" /> Pausar
          </button>
          <button
            onClick={parar}
            className="inline-flex items-center gap-2 text-brand-muted hover:text-red-500 font-bold text-sm px-3 py-2 rounded-xl transition-colors"
          >
            <Square className="size-4" /> Parar
          </button>
          <span className="inline-flex items-center gap-1.5 text-xs text-brand-accent font-semibold">

...
export function CinematicHero({ 
  ...
  useEffect(() => {
    const handleMouseMove = (e: MouseEvent) => {
      if (window.scrollY > (containerRef.current?.offsetHeight || 0) * 2) return;
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        .to([".mockup-scroll-wrapper", ".floating-badge", ".card-left-text", ".card-right-text"], {
          scale: 0.9, y: -40, z: -200, autoAlpha: 0, ease: "power3.in", duration: 0.3, stagger: 0.05,
        })
        ...
        .to(".main-card", { y: -window.innerHeight - 300, ease: "power3.in", duration: 0.4 });
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-full px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="#" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            <MapPin className="w-6 h-6 transition-transform group-hover:scale-110" />
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">Ver avaliações no</div>
              <div className="text-xl font-bold leading-none tracking-tight">Google Maps</div>
            </div>
          </a>
          <a href="#" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background">
            <MessageSquare className="w-6 h-6 transition-transform group-hover:scale-110 text-emerald-400" />
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">Fale com um</div>
              <div className="text-xl font-bold leading-none tracking-tight">Especialista</div>
            </div>
          </a>
        </div>
      </div>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-20 w-full">
              <h2 className="text-4xl md:text-[4rem] lg:text-[6rem] font-black uppercase tracking-tighter text-card-silver-matte lg:mt-0 leading-none text-center lg:text-right">
                {brandName}
              </h2>
            </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-bold mb-1">Feedback</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Avaliações</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">TE</div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500/20 to-emerald-600/5 flex items-center justify-center mr-3 border border-emerald-400/20 shadow-inner">
                            <Heart className="w-4 h-4 text-emerald-400 fill-emerald-400 drop-shadow-md" />
                          </div>
                          <div className="flex-1">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-0 lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-0 lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-emerald-500/20 to-emerald-900/10 flex items-center justify-center border border-emerald-400/30 shadow-inner">
                    <Heart className="w-4 h-4 lg:w-5 lg:h-5 text-emerald-400 fill-emerald-400 drop-shadow-lg" />
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Fidelidade Total</p>
                    <p className="text-emerald-200/50 text-[10px] lg:text-xs font-medium">Compromisso real</p>
                  </div>
                </div>
